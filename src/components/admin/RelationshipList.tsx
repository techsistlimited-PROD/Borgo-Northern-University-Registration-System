...
import { Home, Users, Eye, Pencil, Trash2, Download, Printer, Search } from 'lucide-react'
import { DEMO_MODE, showDemoToast } from '@/config/demo'
import { relationshipsStatic, type Relationship } from '@/lib/generalSettingsSeeds'

export default function RelationshipListView() {
  const [data, setData] = useState<Relationship[]>(relationshipsStatic)
  ...
  const handleDelete = (item: Relationship) => {
    if (DEMO_MODE) {
      ...
      alert(showDemoToast(`Delete "${item.relationship}"`))
    }
  }
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <span>/</span>
          <span className="text-deep-plum font-medium">Relationship List</span>
        </div>
        ...
        <CardContent>
          <div className="mb-4">
            <div className="relative">
              ...
              <Input
                placeholder="Search by relationship or code..."
                value={search}
            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="text-left p-3 text-sm font-medium">Relationship</th>
              ...
              <tbody>
                {filtered.map((item) => (
                  <tr key={item.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-3 text-sm font-medium">{item.relationship}</td>
                    <td className="p-3">
          ...
          {viewItem && (
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-base mt-1">{viewItem.relationship}</p>
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    value={editItem.relationship}
                    onChange={(e) => setEditItem({...editItem, relationship: e.target.value})}
                    className="mt-1"
                  />
                </div>
                <div>
