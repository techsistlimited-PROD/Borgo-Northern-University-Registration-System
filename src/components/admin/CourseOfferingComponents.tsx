...
export const SectionManagement = () => {
  ...
  // Student management states for Section Management
  const [showSectionStudentModal, setShowSectionStudentModal] = useState(false)
  const [currentSectionForStudentMgmt, setCurrentSectionForStudentMgmt] = useState<any>(null)
  const [newStudentIdSM, setNewStudentIdSM] = useState('')
  const [bulkStudentFromSM, setBulkStudentFromSM] = useState('')
  const [bulkStudentToSM, setBulkStudentToSM] = useState('')
  const [studentAssignmentModeSM, setStudentAssignmentModeSM] = useState('single') // 'single' or 'bulk'

  // Section student data (shared with OfferCourses component concept)
  const [sectionStudentsSM, setSectionStudentsSM] = useState<{[key: string]: string[]}>({
    'A': [
      '2024-1-60-001', '2024-1-60-002', '2024-1-60-003', '2024-1-60-004', '2024-1-60-005',
      '2024-1-60-006', '2024-1-60-007', '2024-1-60-008', '2024-1-60-009', '2024-1-60-010',
      '2024-1-60-011', '2024-1-60-012', '2024-1-60-013', '2024-1-60-014', '2024-1-60-015',
      ...
      '2024-1-60-036', '2024-1-60-037', '2024-1-60-038', '2024-1-60-039', '2024-1-60-040',
      '2024-1-60-041', '2024-1-60-042', '2024-1-60-043', '2024-1-60-044', '2024-1-60-045',
      '2024-1-60-046', '2024-1-60-047', '2024-1-60-048'
    ],
    'B': [
      '2024-1-60-101', '2024-1-60-102', '2024-1-60-103', '2024-1-60-104', '2024-1-60-105',
      '2024-1-60-106', '2024-1-60-107', '2024-1-60-108', '2024-1-60-109', '2024-1-60-110',
      ...
      '2024-1-60-121', '2024-1-60-122', '2024-1-60-123', '2024-1-60-124', '2024-1-60-125',
      '2024-1-60-126', '2024-1-60-127', '2024-1-60-128', '2024-1-60-129', '2024-1-60-130',
      '2024-1-60-131', '2024-1-60-132', '2024-1-60-133', '2024-1-60-134', '2024-1-60-135',
      '2024-1-60-136', '2024-1-60-137', '2024-1-60-138', '2024-1-60-139', '2024-1-60-140',
      '2024-1-60-141', '2024-1-60-142', '2024-1-60-143'
    ],
    'C': [
      '2024-1-60-201', '2024-1-60-202', '2024-1-60-203', '2024-1-60-204', '2024-1-60-205',
      '2024-1-60-206', '2024-1-60-207', '2024-1-60-208', '2024-1-60-209', '2024-1-60-210',
      '2024-1-60-211', '2024-1-60-212', '2024-1-60-213', '2024-1-60-214', '2024-1-60-215',
      '2024-1-60-216', '2024-1-60-217', '2024-1-60-218', '2024-1-60-219', '2024-1-60-220',
      '2024-1-60-221', '2024-1-60-222', '2024-1-60-223', '2024-1-60-224', '2024-1-60-225',
      '2024-1-60-226', '2024-1-60-227', '2024-1-60-228', '2024-1-60-229', '2024-1-60-230',
      '2024-1-60-231', '2024-1-60-232', '2024-1-60-233', '2024-1-60-234', '2024-1-60-235'
    ]
  })
