            ...
            <table className="w-full">
              <thead className="bg-gray-50 sticky top-0">
                <tr>
                  ...
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Total Days</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Weekend</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Holiday</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Leave</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Late In</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Early Out</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Absent</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Total Present</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Total Duty Hrs</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Default</th>
                  <th className="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase">Surplus</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {employeeSummaries.map((summary) => (
                  <tr key={summary.employeeId}>
                    ...
                    <td className="px-2 py-3 text-sm text-gray-600">{summary.totalDays}</td>
                    <td className="px-2 py-3 text-sm text-gray-600">{summary.weekend}</td>
                    <td className="px-2 py-3 text-sm text-gray-600">{summary.holiday}</td>
                    <td className="px-2 py-3 text-sm text-gray-600">{summary.leave}</td>
                    <td className="px-2 py-3 text-sm text-gray-600">{summary.lateIn}</td>
