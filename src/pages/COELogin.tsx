        ...
        <Card className="shadow-2xl border-0">
          <CardHeader className="space-y-4 pb-4">
            ...
            <div className="text-center">
              <CardTitle className="text-2xl text-deep-plum">Controller of Examinations</CardTitle>
              <CardDescription className="mt-2">
                Enter your credentials to access the examination management portal
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 p-3 bg-mint-green/20 rounded-md">
              ...
              <div className="flex items-center justify-between mt-1">
                ...
                <Button
                  ...
                  variant="outline"
                  className="ml-4"
                  onClick={() => setCredentials({ username: 'coe', password: 'coe123' })}
                >
                  Fill Demo
                </Button>
              </div>
